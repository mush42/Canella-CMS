...
class CanellaChangePasswordForm(NewPasswordConfirmMixin, Form):
    ...
    def __init__(self, user, *args, **kwargs):
        self.user = user
        super(CanellaChangePasswordForm, self).__init__(*args, **kwargs)

    def validate(self):
        if not super(CanellaChangePasswordForm, self).validate():
            return False
