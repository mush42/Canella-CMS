...
from ..core.models import Site, Displayable
from ..util.admin import date_column_formatter
...
DISPLAYABEL_DEFAULTS = dict(
    ...
    form_rules = ("title", "status", "publish_date", 'expire_date', "slug", "meta_title", "meta_description", "has_auto_desc", "keywords", ),
...
class DisplayableAdmin(CanellaModelView, metaclass=DisplayableAdminType):
